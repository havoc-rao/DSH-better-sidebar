...
export const ar: Record<string, string> = {
  ...
  allowOpenOutside: 'السماح بفتح ملفات خارج مساحة العمل',
  allowOpenOutsideDesc: 'عند التفعيل، يمكن للمحرر والمعاينات وشجرة الملفات فتح مسارات خارج مساحة عمل الجلسة (قراءة وتصفّح فقط)؛ يبقى الحفظ والرفع محصورين في مساحة العمل. معطّل افتراضيًا — الحفاظ على حدود واجهة الملفات',
  ...
  fetch: 'جلب',
  fetchPrune: 'جلب وتنظيف',
  fetching: 'جارٍ الجلب…',
  fetchError: 'فشل الجلب',
  noRemote: 'لا يوجد مستودع بعيد مكوّن',
  noUpstream: 'لا يوجد فرع أعلى',
  upstreamGone: 'الفرع الأعلى محذوف',
  branchStatusUpToDate: 'محدّث',
  branchStatusTooltip: 'مقابل {upstream}: {ahead} أمام، {behind} خلف',
  watchBranches: 'فروع مُتابَعة',
  watchedAhead: 'متقدم {count} commits',
  watchedBehind: 'متأخر {count} commits',
  watchClear: 'إلغاء الكل',
  history: 'السجل',
