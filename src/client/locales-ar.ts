...
export const ar: Record<string, string> = {
  ...
  fetch: 'جلب',
  fetching: 'جارٍ الجلب…',
  fetchPrune: 'جلب مع التقليم (--prune)',
  fetchError: 'فشل الجلب',
  noRemote: 'لا يوجد remote مُهيأ',
  noUpstream: 'لا يوجد upstream',
  upstreamGone: 'تم حذف upstream',
  branchStatusUpToDate: 'مُحدَّث',
  branchStatusTooltip: '{upstream}: {ahead} متقدم، {behind} متأخر',
  history: 'السجل',
  changes: 'التغييرات',
  staged: 'مُدرج',
  unstaged: 'غير مُدرج',
