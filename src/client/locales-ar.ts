...
export const ar: Record<string, string> = {
  ...
  diffOpenFile: 'فتح الملف',
  diffOpenFileAt: 'فتح الملف عند السطر {line}',
  diffProposedNote: 'لقطة خطة · معاينة نصية للقراءة فقط، لا يتم تشغيل git',
  diffProposedTruncated: 'تم اقتطاع معاينة الفرق (جزئي)',
  diffUnparseable: 'تعذر تحليل نص الفرق هذا',
  diffBinary: 'ثنائي',
  diffAdded: 'مُضاف',
  diffDeleted: 'محذوف',
