...
export const id: Record<string, string> = {
  ...
  fetch: 'Ambil',
  fetching: 'Mengambil…',
  fetchPrune: 'Ambil dengan prune (--prune)',
  fetchError: 'Gagal mengambil',
  noRemote: 'Tidak ada remote yang dikonfigurasi',
  noUpstream: 'Tanpa upstream',
  upstreamGone: 'Upstream dihapus',
  branchStatusUpToDate: 'Terbaru',
  branchStatusTooltip: '{upstream}: {ahead} di depan, {behind} di belakang',
  history: 'Riwayat',
  changes: 'Perubahan',
  staged: 'Staged',
  unstaged: 'Unstaged',
