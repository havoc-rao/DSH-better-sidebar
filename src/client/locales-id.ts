...
export const id: Record<string, string> = {
  ...
  fetch: 'Ambil',
  fetchPrune: 'Ambil & bersihkan',
  fetching: 'Mengambil…',
  fetchError: 'Gagal mengambil',
  noRemote: 'Tidak ada remote dikonfigurasi',
  noUpstream: 'Tidak ada branch upstream',
  upstreamGone: 'Upstream dihapus',
  branchStatusUpToDate: 'Terbaru',
  branchStatusTooltip: 'vs {upstream}: {ahead} di depan, {behind} di belakang',
  watchBranches: 'Branch yang dipantau',
  watchedAhead: '{count} commit di depan',
  watchedBehind: '{count} commit di belakang',
  watchClear: 'Hapus semua',
  history: 'Riwayat',
