...
export const id: Record<string, string> = {
  ...
  diffOpenFile: 'Buka file',
  diffOpenFileAt: 'Buka file di baris {line}',
  diffProposedNote: 'Cuplikan rencana · pratinjau teks hanya-baca, git tidak dijalankan',
  diffProposedTruncated: 'Pratinjau diff terpotong (sebagian)',
  diffUnparseable: 'Tidak dapat mengurai teks diff ini',
  diffBinary: 'Biner',
  ...
  settingsLanguageTitle: 'Bahasa antarmuka',
  settingsLanguageDesc: 'Bahasa tampilan antarmuka DSH (preferensi yang sama dengan baris Bahasa di Umum)',
