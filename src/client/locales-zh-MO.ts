...
export const zhMO: Record<string, string> = {
  ...
  fetch: '抓取',
  fetchPrune: '抓取並清理遠端參照',
  fetching: '抓取中…',
  fetchError: '抓取失敗',
  noRemote: '未設定遠端倉庫',
  noUpstream: '無上游分支',
  upstreamGone: '上游已刪除',
  branchStatusUpToDate: '與上游同步',
  branchStatusTooltip: '相對上游「{upstream}」：領先 {ahead}，落後 {behind}',
  watchBranches: '重點關注分支',
  watchedAhead: '領先 {count} 個提交',
  watchedBehind: '落後 {count} 個提交',
  watchClear: '全部取消關注',
  history: '歷史',
  changes: '檔案變動',
  changesGitLens: 'Git',
