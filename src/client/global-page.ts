 ...
 * The page's OWN bottom workbench (the virtual `global-workspace` session)
 * receives the global windows the user attaches from the cards — real
 * sessions are never touched by the page.
 */
