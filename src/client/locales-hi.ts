...
export const hi: Record<string, string> = {
  ...
  allowOpenOutside: 'कार्यक्षेत्र के बाहर की फ़ाइलें खोलने की अनुमति दें',
  allowOpenOutsideDesc: 'चालू होने पर संपादक, पूर्वावलोकन और फ़ाइल ट्री सत्र के कार्यक्षेत्र के बाहर के पथ भी खोल सकते हैं (केवल पढ़ना/ब्राउज़ करना); सहेजना और अपलोड कार्यक्षेत्र तक ही सीमित रहते हैं। डिफ़ॉल्ट बंद — फ़ाइल API की कार्यक्षेत्र सीमा बनी रहती है',
  ...
  fetch: 'खींचें',
  fetchPrune: 'खींचें और साफ़ करें',
  fetching: 'खींच रहे हैं…',
  fetchError: 'खींचना विफल',
  noRemote: 'कोई रिमोट कॉन्फ़िगर नहीं',
  noUpstream: 'कोई अपस्ट्रीम शाखा नहीं',
  upstreamGone: 'अपस्ट्रीम हटा दिया गया',
  branchStatusUpToDate: 'अद्यतित',
  branchStatusTooltip: '{upstream} की तुलना: {ahead} आगे, {behind} पीछे',
  watchBranches: 'ध्यान वाली ब्रांचें',
  watchedAhead: '{count} कमिट आगे',
  watchedBehind: '{count} कमिट पीछे',
  watchClear: 'सभी हटाएँ',
  history: 'इतिहास',
  changes: 'बदलाव',
  staged: 'स्टेज किया',
  unstaged: 'अनस्टेज',
