...
export const hi: Record<string, string> = {
  ...
  diffOpenFile: 'फ़ाइल खोलें',
  diffOpenFileAt: 'फ़ाइल को पंक्ति {line} पर खोलें',
  diffProposedNote: 'योजना स्नैपशॉट · केवल-पढ़ने योग्य टेक्स्ट पूर्वावलोकन, git नहीं चलाया जाता',
  diffProposedTruncated: 'डिफ़ पूर्वावलोकन काटा गया (आंशिक)',
  diffUnparseable: 'इस डिफ़ टेक्स्ट को पार्स नहीं किया जा सकता',
  diffBinary: 'बाइनरी',
  diffAdded: 'जोड़ा',
  diffDeleted: 'हटाया',
