...
export const de: Record<string, string> = {
  ...
  diffOpenFile: 'Datei öffnen',
  diffOpenFileAt: 'Datei in Zeile {line} öffnen',
  diffProposedNote: 'Plan-Schnappschuss · schreibgeschützte Textvorschau, kein git-Aufruf',
  diffProposedTruncated: 'Diff-Vorschau gekürzt (teilweise)',
  diffUnparseable: 'Dieser Diff-Text kann nicht geparst werden',
  diffBinary: 'Binär',
