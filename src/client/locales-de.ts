...
export const de: Record<string, string> = {
  ...
  fetch: 'Abrufen',
  fetchPrune: 'Abrufen & bereinigen',
  fetching: 'Abrufen…',
  fetchError: 'Abruf fehlgeschlagen',
  noRemote: 'Kein Remote konfiguriert',
  noUpstream: 'Kein Upstream-Zweig',
  upstreamGone: 'Upstream entfernt',
  branchStatusUpToDate: 'Aktuell',
  branchStatusTooltip: 'vs. {upstream}: {ahead} voraus, {behind} zurück',
  watchBranches: 'Beobachtete Branches',
  watchedAhead: '{count} Commits voraus',
  watchedBehind: '{count} Commits zurück',
  watchClear: 'Alle aufheben',
  history: 'Verlauf',
  changes: 'Änderungen',
  staged: 'Gestaged',
