export const pt: Record<string, string> = {
  ...
  fetch: 'Buscar',
  fetching: 'Buscando…',
  fetchPrune: 'Buscar com poda (--prune)',
  fetchError: 'Falha ao buscar',
  noRemote: 'Nenhum remoto configurado',
  noUpstream: 'Sem upstream',
  upstreamGone: 'Upstream removido',
  branchStatusUpToDate: 'Atualizado',
  branchStatusTooltip: '{upstream}: {ahead} à frente, {behind} atrás',
  history: 'Histórico',
  changes: 'Alterações',
  staged: 'Preparadas',
