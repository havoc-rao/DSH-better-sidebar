export const pt: Record<string, string> = {
  ...
  fetch: 'Buscar',
  fetchPrune: 'Buscar e limpar',
  fetching: 'Buscando…',
  fetchError: 'Falha na busca',
  noRemote: 'Nenhum repositório remoto configurado',
  noUpstream: 'Sem branch upstream',
  upstreamGone: 'Upstream removido',
  branchStatusUpToDate: 'Em dia',
  branchStatusTooltip: 'vs {upstream}: {ahead} à frente, {behind} atrás',
  watchBranches: 'Branches acompanhadas',
  watchedAhead: '{count} commits à frente',
  watchedBehind: '{count} commits atrás',
  watchClear: 'Limpar todas',
  history: 'Histórico',
  changes: 'Alterações',
  staged: 'Preparadas',
