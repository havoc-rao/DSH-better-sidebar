export const pt: Record<string, string> = {
  ...
  diffOpenFileAt: 'Abrir arquivo na linha {line}',
  diffProposedNote: 'Instantâneo do plano · prévia de texto somente leitura, nenhum git é executado',
  diffProposedTruncated: 'Prévia do diff truncada (parcial)',
  diffUnparseable: 'Não é possível analisar este texto de diff',
  diffBinary: 'Binário',
  ...
  settingsLanguageTitle: 'Idioma da interface',
  settingsLanguageDesc: 'Idioma de exibição da interface DSH (mesma preferência da linha «Idioma» em Geral)',
