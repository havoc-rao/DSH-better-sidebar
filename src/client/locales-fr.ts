...
export const fr: Record<string, string> = {
  ...
  diffOpenFile: 'Ouvrir le fichier',
  diffOpenFileAt: 'Ouvrir le fichier à la ligne {line}',
  diffProposedNote: 'Aperçu du plan · prévisualisation en lecture seule, aucun git n\'est exécuté',
  diffProposedTruncated: 'Aperçu du diff tronqué (partiel)',
  diffUnparseable: 'Impossible d\'analyser ce texte de diff',
  diffBinary: 'Binaire',
  diffAdded: 'Ajouté',
