...
export const fr: Record<string, string> = {
  ...
  fetchPrune: 'Récupérer avec nettoyage (--prune)',
  fetchError: 'Échec de la récupération',
  noRemote: 'Aucun dépôt distant configuré',
  noUpstream: 'Pas de branche amont',
  upstreamGone: 'Branche amont supprimée',
  branchStatusUpToDate: 'À jour',
  branchStatusTooltip: '{upstream} : {ahead} en avance, {behind} en retard',
  history: 'Historique',
