...
export const pl: Record<string, string> = {
  ...
  diffOpenFile: 'Otwórz plik',
  diffOpenFileAt: 'Otwórz plik w linii {line}',
  diffProposedNote: 'Migawka planu · podgląd tekstu tylko do odczytu, git nie jest uruchamiany',
  diffProposedTruncated: 'Podgląd diffa przycięty (częściowy)',
  diffUnparseable: 'Nie można przeanalizować tego tekstu diff',
  diffBinary: 'Binarny',
  diffAdded: 'Dodany',
