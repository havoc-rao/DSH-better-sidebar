...
export const pl: Record<string, string> = {
  ...
  fetch: 'Pobierz',
  fetching: 'Pobieranie…',
  fetchPrune: 'Pobierz z czyszczeniem (--prune)',
  fetchError: 'Pobieranie nie powiodło się',
  noRemote: 'Brak skonfigurowanego remote',
  noUpstream: 'Brak upstream',
  upstreamGone: 'Upstream usunięty',
  branchStatusUpToDate: 'Na bieżąco',
  branchStatusTooltip: '{upstream}: {ahead} do przodu, {behind} do tyłu',
  history: 'Historia',
  changes: 'Zmiany',
  staged: 'W indeksie',
