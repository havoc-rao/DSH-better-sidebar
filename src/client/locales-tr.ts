...
export const tr: Record<string, string> = {
  ...
  fetch: 'Çek',
  fetchPrune: 'Çek ve temizle',
  fetching: 'Çekiliyor…',
  fetchError: 'Çekme başarısız',
  noRemote: 'Uzak depo yapılandırılmamış',
  noUpstream: 'Üst dal yok',
  upstreamGone: 'Üst dal silindi',
  branchStatusUpToDate: 'Güncel',
  branchStatusTooltip: '{upstream} karşısında: {ahead} ileride, {behind} geride',
  watchBranches: 'İzlenen dallar',
  watchedAhead: '{count} commit ileride',
  watchedBehind: '{count} commit geride',
  watchClear: 'Tümünü kaldır',
  history: 'Geçmiş',
