...
export const tr: Record<string, string> = {
  ...
  diffOpenFile: 'Dosyayı aç',
  diffOpenFileAt: 'Dosyayı {line}. satırda aç',
  diffProposedNote: 'Plan anlık görüntüsü · salt okunur metin önizlemesi, git çalıştırılmaz',
  diffProposedTruncated: 'Diff önizlemesi kısaltıldı (kısmi)',
  diffUnparseable: 'Bu diff metni ayrıştırılamıyor',
  diffBinary: 'İkili',
  diffAdded: 'Eklendi',
  diffDeleted: 'Silindi',
