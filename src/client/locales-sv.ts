export const sv: Record<string, string> = {
  ...
  diffOpenFile: 'Öppna fil',
  diffOpenFileAt: 'Öppna fil på rad {line}',
  diffProposedNote: 'Plansnapshot · skrivskyddad textförhandsvisning, ingen git körs',
  diffProposedTruncated: 'Diff-förhandsvisning trunkerad (delvis)',
  diffUnparseable: 'Kan inte tolka denna diff-text',
  diffBinary: 'Binär',
  diffAdded: 'Tillagd',
