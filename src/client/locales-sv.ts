export const sv: Record<string, string> = {
  ...
  fetch: 'Hämta',
  fetchPrune: 'Hämta och städa',
  fetching: 'Hämtar…',
  fetchError: 'Hämtning misslyckades',
  noRemote: 'Ingen fjärrkonfiguration',
  noUpstream: 'Ingen upstream-gren',
  upstreamGone: 'Upstream borttagen',
  branchStatusUpToDate: 'Aktuell',
  branchStatusTooltip: 'mot {upstream}: {ahead} före, {behind} efter',
  watchBranches: 'Bevakade grenar',
  watchedAhead: '{count} commits före',
  watchedBehind: '{count} commits efter',
  watchClear: 'Rensa alla',
  history: 'Historik',
  changes: 'Ändringar',
  staged: 'Köade',
  unstaged: 'Avköade',
