...
export const ko: Record<string, string> = {
  ...
  diffOpenFile: '파일 열기',
  diffOpenFileAt: '파일을 {line}번째 줄에서 열기',
  diffProposedNote: '계획 스냅샷 · 읽기 전용 텍스트 미리보기, git은 실행되지 않음',
  diffProposedTruncated: 'Diff 미리보기 잘림 (부분)',
  diffUnparseable: '이 diff 텍스트를 구문 분석할 수 없습니다',
  diffBinary: '이진',
  diffAdded: '추가됨',
  diffDeleted: '삭제됨',
  diffRenamed: '이름 변경됨',
