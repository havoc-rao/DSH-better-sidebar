...
export const ko: Record<string, string> = {
  ...
  fetch: '가져오기',
  fetchPrune: '가져오기 및 정리',
  fetching: '가져오는 중…',
  fetchError: '가져오기 실패',
  noRemote: '원격 저장소가 설정되지 않음',
  noUpstream: '업스트림 브랜치 없음',
  upstreamGone: '업스트림 삭제됨',
  branchStatusUpToDate: '최신 상태',
  branchStatusTooltip: '업스트림 {upstream} 대비: {ahead} 앞섬, {behind} 뒤처짐',
  watchBranches: '관심 브랜치',
  watchedAhead: '{count}커밋 앞섬',
  watchedBehind: '{count}커밋 뒤처짐',
  watchClear: '모두 해제',
  history: '기록',
  changes: '변경 사항',
  staged: '스테이징됨',
