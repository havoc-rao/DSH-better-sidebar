...
export const vi: Record<string, string> = {
  ...
  diffOpenFile: 'Mở tệp',
  diffOpenFileAt: 'Mở tệp tại dòng {line}',
  diffProposedNote: 'Ảnh chụp kế hoạch · xem trước văn bản chỉ đọc, không chạy git',
  diffProposedTruncated: 'Bản xem trước diff đã bị cắt (một phần)',
  diffUnparseable: 'Không thể phân tích văn bản diff này',
  diffBinary: 'Nhị phân',
  diffAdded: 'Thêm',
  diffDeleted: 'Xóa',
  diffRenamed: 'Đổi tên',
