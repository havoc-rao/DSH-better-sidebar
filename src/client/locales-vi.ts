...
export const vi: Record<string, string> = {
  ...
  fetch: 'Kéo',
  fetchPrune: 'Kéo và dọn dẹp',
  fetching: 'Đang kéo…',
  fetchError: 'Kéo thất bại',
  noRemote: 'Chưa cấu hình remote',
  noUpstream: 'Không có nhánh thượng nguồn',
  upstreamGone: 'Thượng nguồn đã xóa',
  branchStatusUpToDate: 'Mới nhất',
  branchStatusTooltip: 'so với {upstream}: {ahead} đi trước, {behind} đi sau',
  watchBranches: 'Nhánh theo dõi',
  watchedAhead: 'vượt {count} commit',
  watchedBehind: 'chậm {count} commit',
  watchClear: 'Bỏ hết',
  history: 'Lịch sử',
  changes: 'Thay đổi',
  staged: 'Đã stage',
