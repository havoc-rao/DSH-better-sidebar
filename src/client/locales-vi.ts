...
export const vi: Record<string, string> = {
  ...
  fetchPrune: 'Tìm nạp với dọn dẹp (--prune)',
  fetchError: 'Tìm nạp thất bại',
  noRemote: 'Chưa cấu hình remote',
  noUpstream: 'Không có upstream',
  upstreamGone: 'Upstream đã bị xóa',
  branchStatusUpToDate: 'Đã đồng bộ',
  branchStatusTooltip: '{upstream}: trước {ahead}, sau {behind}',
  history: 'Lịch sử',
  changes: 'Thay đổi',
  staged: 'Đã stage',
  unstaged: 'Chưa stage',
