...
export const ja: Record<string, string> = {
  ...
  diffOpenFile: 'ファイルを開く',
  diffOpenFileAt: 'ファイルを {line} 行目で開く',
  diffProposedNote: 'プラン スナップショット · 読み取り専用テキスト プレビュー（git は実行されません）',
  diffProposedTruncated: '差分は切り詰められています（部分プレビュー）',
  diffUnparseable: 'この差分テキストを解析できません',
  diffBinary: 'バイナリ',
  diffAdded: '追加',
  diffDeleted: '削除',
  diffRenamed: '名前変更',
