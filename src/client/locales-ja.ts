...
export const ja: Record<string, string> = {
  ...
  fetch: 'フェッチ',
  fetchPrune: 'フェッチ＆プルーン',
  fetching: 'フェッチ中…',
  fetchError: 'フェッチ失敗',
  noRemote: 'リモートが設定されていません',
  noUpstream: '上流ブランチなし',
  upstreamGone: '上流は削除済み',
  branchStatusUpToDate: '最新です',
  branchStatusTooltip: '上流「{upstream}」に対して：{ahead} 先行、{behind} 遅延',
  watchBranches: '注目ブランチ',
  watchedAhead: '{count} コミット先行',
  watchedBehind: '{count} コミット遅延',
  watchClear: 'すべて解除',
  history: '履歴',
  changes: '変更',
  staged: 'ステージ済み',
