...
export const it: Record<string, string> = {
  ...
  diffOpenFile: 'Apri file',
  diffOpenFileAt: 'Apri il file alla riga {line}',
  diffProposedNote: 'Istantanea del piano · anteprima testo in sola lettura, nessun git eseguito',
  diffProposedTruncated: 'Anteprima diff troncata (parziale)',
  diffUnparseable: 'Impossibile analizzare questo testo diff',
  diffBinary: 'Binario',
  diffAdded: 'Aggiunto',
