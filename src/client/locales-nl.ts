...
export const nl: Record<string, string> = {
  ...
  diffOpenFile: 'Bestand openen',
  diffOpenFileAt: 'Bestand openen op regel {line}',
  diffProposedNote: 'Plansnapshot · alleen-lezen tekstvoorbeeld, git wordt niet uitgevoerd',
  diffProposedTruncated: 'Diff-voorbeeld afgekapt (gedeeltelijk)',
  diffUnparseable: 'Kan deze diff-tekst niet parseren',
  diffBinary: 'Binair',
