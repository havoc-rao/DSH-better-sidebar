...
export const nl: Record<string, string> = {
  ...
  fetch: 'Ophalen',
  fetchPrune: 'Ophalen & opschonen',
  fetching: 'Ophalen…',
  fetchError: 'Ophalen mislukt',
  noRemote: 'Geen remote geconfigureerd',
  noUpstream: 'Geen upstream-branch',
  upstreamGone: 'Upstream verwijderd',
  branchStatusUpToDate: 'Bijgewerkt',
  branchStatusTooltip: 't.o.v. {upstream}: {ahead} voor, {behind} achter',
  watchBranches: 'Gevolgde branches',
  watchedAhead: '{count} commits voor',
  watchedBehind: '{count} commits achter',
  watchClear: 'Alles wissen',
