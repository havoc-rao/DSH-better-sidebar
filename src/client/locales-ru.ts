...
export const ru: Record<string, string> = {
  ...
  diffOpenFile: 'Открыть файл',
  diffOpenFileAt: 'Открыть файл на строке {line}',
  diffProposedNote: 'Снимок плана · текстовый предпросмотр только для чтения, git не выполняется',
  diffProposedTruncated: 'Предпросмотр diff усечён (частично)',
  diffUnparseable: 'Не удалось разобрать этот текст diff',
  diffBinary: 'Бинарный',
  diffAdded: 'Добавлен',
  diffDeleted: 'Удалён',
