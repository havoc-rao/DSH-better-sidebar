      ...
      */}
      ...
      >
        ...
        {/*
          ...
          of it (the strip's reserved padding covers both). While fullscreen
          (the strip's maximize toggle) the close tap first restores the
          docked panel — a second tap collapses it.
        */}
