...
export const th: Record<string, string> = {
  ...
  diffOpenFile: 'เปิดไฟล์',
  diffOpenFileAt: 'เปิดไฟล์ที่บรรทัด {line}',
  diffProposedNote: 'ภาพรวมแผน · ตัวอย่างข้อความแบบอ่านอย่างเดียว ไม่รัน git',
  diffProposedTruncated: 'ตัวอย่าง diff ถูกตัดทอน (บางส่วน)',
  diffUnparseable: 'ไม่สามารถแยกวิเคราะห์ข้อความ diff นี้ได้',
  diffBinary: 'ไบนารี',
  diffAdded: 'เพิ่ม',
  diffDeleted: 'ลบ',
