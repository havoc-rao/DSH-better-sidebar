...
export const th: Record<string, string> = {
  ...
  allowOpenOutside: 'อนุญาตเปิดไฟล์นอกพื้นที่ทำงาน',
  allowOpenOutsideDesc: 'เมื่อเปิด ตัวแก้ไข หน้าตัวอย่าง และแผนผังไฟล์สามารถเปิดเส้นทางนอกพื้นที่ทำงานของเซสชันได้ (อ่านและเรียกดูเท่านั้น); การบันทึกและการอัปโหลดยังจำกัดอยู่ในพื้นที่ทำงาน ปิดโดยค่าเริ่มต้น — คงขอบเขตพื้นที่ทำงานของไฟล์ API',
  ...
  watchBranches: 'สาขาที่ติดตาม',
  watchedAhead: 'นำหน้า {count} คอมมิต',
  watchedBehind: 'ล้าหลัง {count} คอมมิต',
  watchClear: 'ยกเลิกทั้งหมด',
  history: 'ประวัติ',
