...
export const th: Record<string, string> = {
  ...
  fetchPrune: 'ดึงข้อมูลพร้อมตัดกิ่ง (--prune)',
  fetchError: 'ดึงข้อมูลล้มเหลว',
  noRemote: 'ไม่ได้กำหนด remote',
  noUpstream: 'ไม่มี upstream',
  upstreamGone: 'upstream ถูกลบแล้ว',
  branchStatusUpToDate: 'เท่าทัน',
  branchStatusTooltip: '{upstream}: ไปข้างหน้า {ahead} ถอยหลัง {behind}',
  history: 'ประวัติ',
