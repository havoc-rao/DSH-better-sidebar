...
export const zh = {
  ...
  bindGlobal: '全局共享（所有项目）',
  unbindGlobal: '取消全局共享',
  globalInfo: '全局工作区',
  globalInfoFooter: '全局工作区',
  globalInfoDesc: '记录所有实例级全局工作区信息（含全局共享终端）',
  globalInfoSection: '全局共享窗口',
  globalInfoEmpty: '暂无全局共享窗口。在终端 tab 上右键 → 「全局共享（所有项目）」即可跨所有项目共享同一个终端。',
  globalInfoEmptyTitle: '还没有全局共享终端',
  globalInfoCount: '{count} 个全局共享窗口',
  globalInfoSharedAll: '跨所有项目共享',
  globalInfoActivate: '打开',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  bindGlobal: 'Share globally (all projects)',
  unbindGlobal: 'Stop global sharing',
  globalInfo: 'Global Workspace',
  globalInfoFooter: 'Global Workspace',
  globalInfoDesc: 'All instance-level global workspace info (incl. globally shared terminals)',
  globalInfoSection: 'Globally shared windows',
  globalInfoEmpty: 'No globally shared windows. Right-click a terminal tab → “Share globally (all projects)” to share one shell across every project.',
  globalInfoEmptyTitle: 'No globally shared terminals yet',
  globalInfoCount: '{count} globally shared window(s)',
  globalInfoSharedAll: 'Shared across all projects',
  globalInfoActivate: 'Open',
