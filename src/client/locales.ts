...
export const en: Record<keyof typeof zh, string> = {
  ...
  commitDraftTooltip: 'Draft a commit message with AI (staged changes + history style reference; LLM & template come from the settings)',
  commitDraftNoStaged: 'Nothing is staged — stage some changes first',
  commitDraftNoLlm: 'No LLM configured for AI drafting',
  commitDraftNoLlmDesc: 'Pick an LLM provider, model and commit template in the Side card settings → Source Control → gear popup',
  commitDraftFailed: 'AI drafting failed',
  gitLlmProvider: 'LLM provider',
  gitLlmModel: 'Model',
  gitLlmModelPlaceholder: 'Type or pick a model id',
