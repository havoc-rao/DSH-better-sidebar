...
export const zh = {
  ...
  fetch: '拉取',
  fetching: '正在拉取…',
  fetchPrune: '拉取并清理（--prune）',
  fetchError: '拉取失败',
  noRemote: '仓库未配置远程',
  noUpstream: '无上游',
  upstreamGone: '上游已删除',
  branchStatusUpToDate: '与上游同步',
  branchStatusTooltip: '{upstream}：领先 {ahead} · 落后 {behind}',
  history: '历史',
  changes: '变更',
  staged: '已暂存',
  unstaged: '未暂存',
