...
export const zh = {
  ...
  globalInfoDesc: '全局共享窗口的完整生命周期（同一个终端会话）都驻留在这里，按需带到任意会话',
  globalInfoSection: '全局共享窗口',
  globalInfoEmpty: '暂无全局共享窗口。在终端 tab 上右键 → 「全局共享（转移到全局工作区）」即可把该终端的生命周期转入全局工作区；需要时点击卡片即可把它带到当前会话。',
  globalInfoEmptyTitle: '还没有全局共享终端',
  globalInfoCount: '{count} 个全局共享窗口',
  globalInfoSharedAll: '驻留全局工作区',
  globalInfoAttach: '点击将窗口带到当前会话',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  globalInfoDesc: 'Globally shared windows live here with their full lifecycle (one terminal session), attachable to any session on demand',
  globalInfoSection: 'Globally shared windows',
  globalInfoEmpty: 'No globally shared windows. Right-click a terminal tab → “Share globally (transfer to Global Workspace)” to park that terminal’s lifecycle here; click its card to bring it into the current session.',
  ...
  globalInfoAttach: 'Click to bring this window to the current session',
