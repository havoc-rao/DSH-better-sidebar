...
export const zh = {
  ...
  diffOpenFile: '打开文件',
  diffOpenFileAt: '打开文件到第 {line} 行',
  diffProposedNote: '计划快照 · 只读文本预览，不执行 git',
  diffProposedTruncated: '差异已截断（部分预览）',
  diffUnparseable: '无法解析这段差异文本',
  diffBinary: '二进制',
  diffAdded: '新增',
  diffDeleted: '删除',
  diffRenamed: '重命名',
  ...
  settingsLanguageDesc: '切换 DSH 界面语言。与「常规」中的语言设置是同一项偏好，两处同步',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  gitCommitActions: 'Commit actions',
  branch: 'Branch',
  worktree: 'Worktree',
  ...
  diffOpenFileAt: 'Open file at line {line}',
  diffProposedNote: 'Plan snapshot · read-only text preview, no git is run',
  diffProposedTruncated: 'Diff preview truncated (partial)',
  diffUnparseable: 'Cannot parse this diff text',
  diffBinary: 'Binary',
  diffAdded: 'Added',
  diffDeleted: 'Deleted',
  diffRenamed: 'Renamed',
  ...
  settingsLanguageDesc: 'Display language for the DSH interface (the same preference as the Language row in General)',
