...
export const zh = {
  ...
  allowOpenOutside: '允许打开工作区外的文件',
  allowOpenOutsideDesc: '开启后，编辑器 / 预览 / 文件树可打开会话工作区之外的路径（仅读取与浏览）；保存与上传仍限于工作区内。默认关闭，保持文件 API 的工作区边界',
  sidebarLayout: '工作台布局',
  ...
  fileTreeSplitter: '拖拽调整上下区域比例（双击重置）',
  ...
  commitDraft: 'AI 生成',
  commitDraftBusy: '生成中…',
  commitDraftTooltip: '用 Git agent 生成提交信息：优先基于已暂存变更，暂存区为空时总结工作区变更',
  ...
  fetch: '抓取',
  fetchPrune: '抓取并清理远程引用',
  fetching: '抓取中…',
  fetchError: '抓取失败',
  noRemote: '未配置远程仓库',
  noUpstream: '无上游分支',
  upstreamGone: '上游已删除',
  branchStatusUpToDate: '与上游同步',
  branchStatusTooltip: '相对上游「{upstream}」：领先 {ahead}，落后 {behind}',
  watchBranches: '重点关注分支',
  watchedAhead: '领先 {count} 个提交',
  watchedBehind: '落后 {count} 个提交',
  watchClear: '全部取消关注',
  history: '历史',
  changes: '文件变动',
  changesGitLens: 'Git',
  ...
  sideChatCollapse: '收起侧边对话',
  sideChatExpand: '展开侧边对话',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  allowOpenOutside: 'Allow opening files outside the workspace',
  allowOpenOutsideDesc: 'When on, the editor, previewers, and file tree may open paths outside the session workspace (read & browse only); saving and uploading stay confined to the workspace. Off by default — keeps the file API workspace boundary',
  sidebarLayout: 'Workbench layout',
  sidebarLayoutDesc: 'The overall layout paradigm of the sidebar',
  sidebarLayoutDocked: 'Docked',
  sidebarLayoutDockedDesc: 'The file tree docks inside each files window (the default behavior)',
  sidebarLayoutVscode: 'VSCode style',
  sidebarLayoutVscodeDesc: 'The file tree becomes an independent side bar, an activity bar sits at the panel edge, the editor stays by the chat',
  sideBarSide: 'Side Bar position',
  sideBarSideDesc: 'Which side of the panel the explorer drawer sits on in the vscode layout (ignored in docked mode)',
  sideBarSideLeft: 'Left',
  sideBarSideLeftDesc: 'File tree | editor | activity bar (the tree hugs the panel\'s left edge)',
  sideBarSideRight: 'Right',
  sideBarSideRightDesc: 'Editor | file tree | activity bar (default — the editor stays by the chat)',
  sideBarSideToggle: 'Toggle the Side Bar position',
  iconTheme: 'File icon theme',
  iconThemeDesc: 'The icon source for the file tree and file windows (available once an icon theme plugin is installed)',
  iconThemeBuiltin: 'Built-in icons',
  sideBarSideLabel: 'Side bar: {side}',
  activityBarLabel: 'Activity bar',
  sideBarExplorer: 'Explorer',
  editorTreeToggle: 'File tree panel',
  fileTreeSplitter: 'Drag to adjust the upper/lower split; double-click to reset',
  ...
  searchNavHint: '↑↓ navigate · Enter open · Esc clear',
  menuKeyboardHint: '1-9 / first letter to pick · ↑↓ to move · Enter to open · Esc to close',
  hotkeyToggleLeftSidebar: 'Toggle the host left sidebar',
  hotkeyToggleRightPanel: 'Toggle the right sidebar',
  hotkeyToggleBottomPanel: 'Toggle the bottom panel',
  hotkeyToggleBottomMaximized: 'Maximize the bottom panel',
  hotkeyToggleChatColumn: 'Toggle the Side Chat column (IDE mode)',
  hotkeyIdeMode: 'Toggle IDE mode (fullscreen right panel)',
  ideModeExit: 'Exit IDE mode',
  hotkeyQuickOpen: 'Quick open: focus the file search',
  hotkeyShowExplorer: 'Show Explorer',
  hotkeyShowGit: 'Show Source Control',
  hotkeyFocusSearch: 'Focus the file search',
  hotkeyNextTab: 'Next tab',
  hotkeyPrevTab: 'Previous tab',
  hotkeyCloseTab: 'Close the active tab',
  hotkeyJumpTab: 'Jump to tab {n}',
  ...
  bindToWorkspace: 'Bind to workspace',
  bindToWorkspaceWithName: 'Bind to workspace “{title}”',
  bindToWorkspaceNoWorkspace: 'Current session is not in any workspace',
  unbindFromWorkspace: 'Unbind from workspace',
  bindGlobal: 'Share globally (transfer to Global Workspace)',
  unbindGlobal: 'Stop global sharing',
  globalInfo: 'Global Workspace',
  globalInfoFooter: 'Global Workspace',
  globalInfoDesc: 'All globally shared terminals park here as tabs — click one to open it (one terminal session, every view stays in sync)',
  globalInfoSection: 'Globally shared windows',
  globalInfoEmpty: 'No globally shared windows yet. Right-click a terminal tab → “Share globally (transfer to Global Workspace)” to park that terminal’s lifecycle here — or mint a fresh global terminal below.',
  globalInfoEmptyTitle: 'No globally shared terminals yet',
  globalInfoCount: '{count} globally shared window(s)',
  globalInfoSharedAll: 'Lives in the Global Workspace',
  globalInfoAttach: 'Click to bring this window into the Global Workspace',
  globalInfoExpand: 'Expand to full page',
  globalInfoDetach: 'Remove from the workbench (the window stays parked)',
  globalInfoParked: 'Parked — click to bring into the workbench',
  globalInfoWorkbenchEmpty: 'Nothing in the workbench yet',
  globalInfoWorkbenchEmptyHint: 'Click a parked tab above to bring a global window into the workbench and open it',
  closeBoundConfirm: 'Click again to confirm close (shared workspace window)',
  ...
  commitDraft: 'AI draft',
  commitDraftBusy: 'Drafting…',
  commitDraftTooltip: 'Draft with the Git agent: use staged changes first, or summarize working-tree changes when the index is empty',
  commitDraftNoStaged: 'The index and working tree have no changes to summarize',
  commitDraftNoLlm: 'No LLM configured for AI drafting',
  commitDraftNoLlmDesc: 'Pick an LLM provider, model and commit template in Side card settings → Git Commit agent',
  commitDraftFailed: 'AI drafting failed',
  gitCommitSettingsTitle: 'Git Commit agent',
  gitLlmProvider: 'LLM provider',
  gitLlmModel: 'Model',
  gitLlmModelPlaceholder: 'Select model',
  gitLlmUnavailable: 'No LLM provider detected — configure a model provider in DSH first (or check whether the LLM service is available)',
  gitLlmProbe: 'Test connection',
  gitLlmProbeTesting: 'Testing…',
  gitLlmProbeSuccess: 'Connected ({ms}ms): {message}',
  gitLlmProbeFailed: 'Connection failed: {message}',
  gitTemplate: 'Commit template',
  gitTemplateConventional: 'Conventional Commits',
  gitTemplateConventionalDesc: 'type(scope): subject + bullet body (feat/fix/docs…)',
  gitTemplateGitmoji: 'Gitmoji',
  gitTemplateGitmojiDesc: 'emoji prefix + short subject + bullet body',
  gitTemplatePlain: 'Plain',
  gitTemplatePlainDesc: 'one-line subject + optional bullet list',
  gitTemplateCustom: 'Custom',
  gitTemplateCustomDesc: 'follows your own instructions',
  gitCustomTemplate: 'Custom template instructions',
  gitCustomTemplatePlaceholder: 'e.g. start every subject with "feat: ", write the body in Chinese bullets…',
  gitHistoryRefs: 'History style-reference count',
  gitHistoryRefsDesc: 'Import the most recent N commit subjects as a style reference (0 disables)',
  branch: 'Branch',
  worktree: 'Worktree',
  ...
  branchStatusUpToDate: 'Up to date',
  branchStatusTooltip: 'vs {upstream}: {ahead} ahead, {behind} behind',
  watchBranches: 'Watch branches',
  watchedAhead: '{count} commits ahead',
  watchedBehind: '{count} commits behind',
  watchClear: 'Clear all watches',
  history: 'History',
  changes: 'Changes',
  changesGitLens: 'Git',
  ...
  explorerGitFooter: 'Git status: changed-file counts under the workspace (M modified · A added · D deleted · R renamed · C copied · U untracked · ! conflict · T type changed)',
  ...
  sideChatCollapse: 'Collapse side chat',
  sideChatExpand: 'Expand side chat',
