...
export const zh = {
  ...
  globalProjectDir: '项目目录',
  globalProjectDirPlaceholder: '新建终端的启动目录（绝对路径；留空默认用户主目录）',
  globalRunningCli: '正在运行的 CLI',
  globalRunningCliNone: '—',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  globalProjectDir: 'Project dir',
  globalProjectDirPlaceholder: 'Start dir for new terminals (absolute path; empty = home)',
  globalRunningCli: 'Running CLI',
  globalRunningCliNone: '—',
