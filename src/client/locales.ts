...
export const en: Record<keyof typeof zh, string> = {
  ...
  globalInfoDesc: 'Globally shared windows live here with their full lifecycle (one terminal session); the Global Workspace is a special session whose own bottom workbench hosts the windows you attach from the cards',
  globalInfoSection: 'Globally shared windows',
  globalInfoEmpty: 'No globally shared windows. Right-click a terminal tab → “Share globally (transfer to Global Workspace)” to park that terminal’s lifecycle here; click its card to bring it into this page’s own bottom workbench.',
  ...
  globalInfoAttach: 'Click to bring this window into the Global Workspace bottom workbench',
